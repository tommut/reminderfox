...
//------------------------------------------------------------------------------
	...
	if(listType == 'VEVENT') {// 'event'
		document.title = (editThis) ? reminderFoxBundle.getString("rf.options.reminder.edit.title")
			: reminderFoxBundle.getString("rf.options.reminder.add.title");
	...
	if ((listType == 'VTODO') || (listType == 'ULIST')) {  // 'tasks' or userlist
		document.title = (editThis) ? reminderFoxBundle.getString("rf.options.todo.edit.title")
			: reminderFoxBundle.getString("rf.options.todo.add.title");
