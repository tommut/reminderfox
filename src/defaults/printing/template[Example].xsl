...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<html>
		...
		<body style="font-family:Arial;font-size:10pt;">
			...
			<h3><xsl:value-of select="general/locale/title"/> USER TEMPLATE</h3>
			<table border="0" style="width: 100%;">
				<tr bgcolor="#9acd32">
					<th style="width: 10%;"><xsl:value-of select="general/locale/date"/></th>
					<th >
		...
		<p>
			<small>
				<xsl:value-of select="general/date"/> -- <xsl:value-of select="general/time"/> (<xsl:value-of select="general/xlsName"/>)
			</small>
		</p>
